...
* The original package name 'com.moodscapes.backend.moodscapes backend' is invalid and this project uses 'com.moodscapes.backend.moodscapes.backend' instead.
